...
class SpaceItemDecoration(
    ...
    @param:IntRange(from = 0) private val skipTop: Int = 0,
    @param:IntRange(from = 0) private val skipBottom: Int = 0
    ...
    companion object {
        ...
        fun create(
            ...
            @IntRange(from = 0) skipTop: Int = 0,
            @IntRange(from = 0) skipBottom: Int = 0
        ): SpaceItemDecoration {
